...
public class KakaoRequestTest {
    ...
    @MockBean KakaoClient kakaoClient;
    ...
    void 카카오_콜백_요청_성공_응답() throws Exception {
        ...
        // given
        KakaoDto dto = KakaoDto.of(1234, "amazon7737");

        // when
        when(kakaoClient.execute(accessToken)).thenReturn(dto);

        // then
        mockMvc.perform(get("/kakao/callback").param("code", accessToken))
                .andDo(print())
